...
<body>
    ...
    <h2 class="formato">Mantenimientos Registrados</h2>
    ...
    <div class="formato row">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $result = @pg_query($db_connection, "INSERT INTO mantenimientos (id_auto,id_mantenimiento,fecha_inicio,fecha_fin,descripcion) VALUES ('$id_auto','$id_mantenimiento','$fecha_inicio','$fecha_fin','$descripcion')");

            $result = pg_query($db_connection, "SELECT * FROM mantenimientos");
            ?>
